...
ignore = [test1,test2,testSudoku,testInfeasibleKnapsack,testInfeasibleUC,test_P1_Brito,
  test_feature_selection_pequeno_viavel,testSudoku4x4,test_MIP_Pequeno_Brito,
  test_P1_Andrew_Bianca_viavel,test_feature_selection_grande,test_feature_selection_medio,testRobustCCUC]
runtests(solveMIP, GurobiSolver();ignore=ignore)
